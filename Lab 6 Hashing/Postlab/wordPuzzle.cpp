...
//big-theta running time of the word-search:rcw
//time (pre-lab): 16403.88 s
//time (in-lab): 9.997 s
//time (post-lab): 2.658 s
...
int main(int argc, char** argv){
  ...
  bool result = readInGrid (argv[2], rows, cols);
	...
	for ( int i = 0; i < 8; i++ ){
	  ...
	  //cout << result  << endl;
	  if(result != "" && result.length() > 2 && a == x.length()){
	    k++;
	    if( i == 0){
    ...
    */
	...
	for ( int i = 0; i < 8; i++ ){
	  ...
	  if(result != "" && result.length() > 2 && a == x.length()){
	    k++;
	    if( i == 0){
	      str += "N (" + to_string(r) + ", " + to_string(c) +"):   " + result + "\n";
	    }
	    if( i == 1){
	      str += "NE(" + to_string(r) + ", " + to_string(c) +"):   " + result + "\n";
	    }
	    if( i == 2){
	      str += "E (" + to_string(r) + ", " + to_string(c) +"):   " + result + "\n";
	    }	    
	    if( i == 3){
	      str += "SE(" + to_string(r) + ", " + to_string(c) +"):   " + result + "\n";
	    }
	     if( i == 4){
	       str += "S (" + to_string(r) + ", " + to_string(c) +"):   " + result + "\n";
	    }
	     if( i == 5){
	       str += "SW(" + to_string(r) + ", " + to_string(c) +"):   " + result + "\n";
	    }
	    if( i == 6){
	      str += "W (" + to_string(r) + ", " + to_string(c) +"):   " + result + "\n";
	    }
	    if( i == 7){
	      str += "NW(" + to_string(r) + ", " + to_string(c) +"):   " + result + "\n";
	    }
	  }
	}
      }
