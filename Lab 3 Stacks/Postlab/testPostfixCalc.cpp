...
int main(){
  ...
  cout << "(IN&POST-LAB)_____postfix notation______" <<endl;


  //in-lab+post-lab part
...
//clang++ -Wall -g -o lab3 postfixCalculator.cpp testPostfixCalc.cpp StackNode.cpp Stack.cpp
